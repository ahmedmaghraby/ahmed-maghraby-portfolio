...
const NavBar = () => {
  ...
  return (
    <nav
      ...
      } nowrap top-30 sticky left-0  right-0  z-50 mx-auto  flex justify-center bg-bg-dark  px-1 py-6 text-main md:px-2 `}
    >
      ...
      >
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          >
            <h4 className="cursor-pointer py-2 px-2 text-[12px] sm:px-4 sm:text-[14px] md:py-1 md:px-4">
              HOME
            </h4>
          </Link>
