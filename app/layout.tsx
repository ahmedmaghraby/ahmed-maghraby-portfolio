...
export const metadata: Metadata = {
    ...
    description:
        `Ahmed Maghraby is an Associate Principal Engineer with ${YEARS_EXP}+ years of experience leading front-end and mobile teams. Specialized in React, Next.js, Micro Frontends, Flutter, and fintech. Based in Riyadh, Saudi Arabia.`,
    generator: "Next.js",
    applicationName: "Ahmed Maghraby — AHMED.OS Portfolio",
    ...
    themeColor: "#f5d393",
    openGraph: {
        title: "Ahmed Maghraby | Associate Principal Engineer — AHMED.OS Portfolio",
        description:
            `${YEARS_EXP}+ years leading front-end & mobile teams. Expert in React, Next.js, Micro Frontends, Flutter, and fintech engineering. Based in Riyadh, Saudi Arabia.`,
        url: BASE_URL,
        siteName: "Ahmed Maghraby | AHMED.OS",
        images: [
            {
    ...
    twitter: {
        ...
        title: "Ahmed Maghraby | AHMED.OS Portfolio",
        description:
            `Associate Principal Engineer with ${YEARS_EXP}+ years in fintech, Micro Frontends, and mobile engineering.`,
...
const websiteSchema = {
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "Ahmed Maghraby — AHMED.OS Portfolio",
    url: BASE_URL,
